...
function renderFeatureItems(){
    ...
    var urls = ["/newsletter", "/contact-us", "/stores", "/events", "/pages/westbrook-kids-fun", "/promotions", "feature7_url"];
    var names = ["Newsletter", "Contact Us", "Shops", "Events", "Kids Fun", "Promotions", "feature 7"];
